...
const aiFeatureDefaults = [
  ...
  { key: "pricing_service_fee_rate", value: "0.10", description: "Fee jasa untuk kalkulasi all-in (decimal)." },
  { key: "pricing_shipping_idr", value: "125000", description: "Biaya ongkir default (IDR) — per kategori." },
  { key: "pricing_tax_rate", value: "0.11", description: "Tarif pajak/bea default (decimal)." },
