...
import { SUMOPOD_BASE_URL_DEFAULT, SUMOPOD_MODEL_DEFAULT } from "@/lib/ai-config";
...
const aiFeatureDefaults = [
  { key: "Model utama", value: SUMOPOD_MODEL_DEFAULT, description: "Model AI dari SumoPod." },
  { key: "AI provider base URL", value: SUMOPOD_BASE_URL_DEFAULT, description: "Endpoint utama API SumoPod." },
