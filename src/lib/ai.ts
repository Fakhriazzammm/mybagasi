...
import { SUMOPOD_BASE_URL_DEFAULT, SUMOPOD_MODEL_DEFAULT } from "./ai-config";

const BASE_URL = (import.meta.env.VITE_SUMOPOD_BASE_URL as string | undefined) ?? SUMOPOD_BASE_URL_DEFAULT;
const MODEL = (import.meta.env.VITE_SUMOPOD_MODEL as string | undefined) ?? SUMOPOD_MODEL_DEFAULT;
